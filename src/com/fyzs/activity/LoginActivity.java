...
public class LoginActivity extends Activity {
		...
		new Thread() {
			public void run() {
				...
				case "教师":
				{
					...
					ok=TeacherLogin.Login(xh, pwd, LoginActivity.this); // 8秒后没有连接上服务器
					break;
				}
				case "学生":
				{
					et.putString("logintype", "学生");
					ok=JwxtHttp.Login(xh, pwd, LoginActivity.this); // 8秒后没有连接上服务器
					break;
				}
				default:
					break;
	...
	public void getUser() {
		...
		SetUser.AddUser(sp.getString("xh", ""), sp.getString("name", ""),
				...
				sp.getString("xibu", "")+loginType, sp.getString("sex", ""), time + "新版1.8");
	}
}
